...
# Created Time:2017-09-01 20:45:19
# Last Change:  2017-09-18 22:09:42
# File Name: haigui_trade.py
...
def handle_bar(context, bar_dict):
    ...
    high_price =FinanceDataMining_DataSource.history_bars(context.s, context.open_observe_time+1, '1d', 'High')
    low_price_for_atr =FinanceDataMining_DataSource.history_bars(context.s, context.open_observe_time+1, '1d', 'Low')
    low_price_for_extreme = FinanceDataMining_DataSource.history_bars(context.s, context.close_observe_time+1, '1d', 'Low')
    close_price = FinanceDataMining_DataSource.history_bars(context.s, context.open_observe_time+2, '1d', 'Close')
